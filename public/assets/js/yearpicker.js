...
`,
  autoHide: true, // Auto hide after selection
  // Event shortcuts
  onShow: null,
  onHide: null,
  onChange: null,
...
const handlers = {
  ...
  globalClick: function globalClick(e) {
    ...
    // Si el click es en el elemento o en el template del yearpicker, no ocultar
    if (target === element || 
        $(target).closest('.yearpicker-container').length > 0 ||
